...
# from sym_utils import rotx, roty, rotz, calc_omega, find_coeffs, enable_printing, dynamicsymbols, printeq
...
J_1x, J_1y, J_1z, J_2x, J_2y, J_2z, J_3x, J_3y, J_3z = sp.symbols("J_1x J_1y J_1z J_2x J_2y J_2z J_3x J_3y J_3z")

# TODO Define time-varying symbols for generalized coordinates and their derivatives
theta, psi, phi = dynamicsymbols('theta, psi, phi') # we have to tell SymPy that these are functions of time
...
R_psi = sp.Matrix([[sp.cos(psi), sp.sin(-psi), 0],
                   [sp.sin(psi), sp.cos(psi), 0],
                   [0, 0, 1]])

R_theta = sp.Matrix([[sp.cos(theta), 0, sp.sin(theta)],
                     [0, 1, 0],
...
p1_in_w = R_psi @ R_theta @ R_phi @ p1_in_b
p2_in_w = R_psi @ R_theta @ p2_in_2
p3_in_w = R_psi @ p3_in_1
...
R1 =  R_psi @ R_theta @ R_phi   #rotation to body 1 
R2 =  R_psi @ R_theta           #rotation to body 2 
R3 =  R_psi                     #rotation to body 3 
...
J1 = sp.diag(J_1x, J_1y, J_1z)
J2 = sp.diag(J_2x, J_2y, J_2z)
J3 = sp.diag(J_3x, J_3y, J_3z)
